...
* Update dependencies, including `smooth_page_indicator` 2.x, `super_tooltip` 2.1.x, and `flutter_lints` 6.x.
* Modernize the native iOS color picker presenter and bundle Apple privacy manifests.
