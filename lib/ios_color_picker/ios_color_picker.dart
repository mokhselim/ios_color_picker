...
import 'package:ios_color_picker/ios_color_picker/color_observer.dart';
import 'package:ios_color_picker/ios_color_picker/helpers/cache_helper.dart';
import 'package:ios_color_picker/ios_color_picker/history_colors.dart';
...
class V3ColorPicker extends StatefulWidget {
  const V3ColorPicker({
    super.key,
  });

  @override
  State<V3ColorPicker> createState() => _V3ColorPickerState();
}

class _V3ColorPickerState extends State<V3ColorPicker> {
  @override
  void initState() {
    CacheHelper.init();
    super.initState();
